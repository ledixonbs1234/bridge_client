...
export function Telemetry({ reloadTrigger }: TelemetryProps) {
  ...
  return (
    <div className="space-y-6 text-left text-zinc-800">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-zinc-50 border border-zinc-200 p-5 rounded-xl shadow-xs">
        ...
        <div className="bg-zinc-50 border border-zinc-200 p-5 rounded-xl shadow-xs">
          ...
          <div className="text-3xl font-bold text-emerald-600">{overallReliability}%</div>
        </div>
        <div className="bg-zinc-50 border border-zinc-200 p-5 rounded-xl shadow-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-zinc-50 border border-zinc-200 p-5 rounded-xl shadow-xs">
          <h3 className="text-sm font-bold text-zinc-700 mb-4">Độ tin cậy của từng Tool (%)</h3>
        ...
        <div className="bg-zinc-50 border border-zinc-200 p-5 rounded-xl shadow-xs">
          <h3 className="text-sm font-bold text-zinc-700 mb-4">Thời gian thực thi trung bình (ms)</h3>
          <div className="space-y-4">
            {report.map((r, idx) => {
